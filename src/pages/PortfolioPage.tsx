    ...
    <div className="pt-24 pb-20 bg-[#F7F7FC] text-[#000048] min-h-screen">
      <section className="relative py-16 sm:py-24 overflow-hidden border-b border-[#E5E5F0] bg-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#5F6078] max-w-2xl mx-auto font-normal leading-relaxed">
            Explore how Vixora Digital Hub builds practical software, AI-powered solutions, and digital platforms that help businesses work better and grow.
          </p>
        </div>
      </section>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-semibold transition-all cursor-pointer ${
                selectedFilter === cat
                  ...
                  : 'bg-white text-[#5F6078] hover:text-[#480878] hover:bg-[#F7F7FC] border border-[#E5E5F0]'
              }`}
            >
              {cat}
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="bg-white rounded-3xl border border-[#E5E5F0] hover:border-[#9030F8]/40 transition-all duration-300 flex flex-col overflow-hidden group shadow-lg hover:-translate-y-1"
            >
              <div className="relative aspect-video overflow-hidden bg-[#08082F] flex items-center justify-center">
                {project.imageUrl ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#480878] via-[#7000F8] to-[#08082F] flex items-center justify-center p-6 text-center">
                    <div className="space-y-1">
                      <div className="w-10 h-10 rounded-xl bg-white/10 text-white border border-white/20 flex items-center justify-center mx-auto">
                ...
                <span className="absolute top-4 left-4 px-3 py-1 rounded-full text-[10px] font-mono font-semibold uppercase bg-[#000048]/85 text-white border border-white/20 backdrop-blur-md">
                  {project.category}
                </span>
              </div>
              ...
              <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-6">
                <div className="space-y-3">
                  <div className="text-xs text-[#5F6078] font-medium">
                    Client: <span className="text-[#000048] font-semibold">{project.client}</span>
                  </div>

                  <h3 className="text-xl font-bold text-[#000048] group-hover:text-[#480878] transition-colors">
                    {project.title}
                  </h3>

                  <p className="text-xs sm:text-sm text-[#5F6078] leading-relaxed">
                ...
                <div className="space-y-3 pt-4 border-t border-[#E5E5F0]">
                  <div className="flex flex-wrap gap-1.5">
                    {project.technologiesUsed.map((tech, tIdx) => (
                      <span
                        key={tIdx}
                        className="px-2.5 py-1 rounded-lg text-[10px] font-mono bg-[#F7F7FC] text-[#000048] border border-[#E5E5F0]"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="p-3 rounded-xl bg-[#480878]/5 border border-[#480878]/15 flex items-start gap-2.5">
                    ...
                    <div className="text-xs text-[#000048]">
                      <strong className="text-[#480878] font-semibold">Outcome: </strong>
                      {project.outcome}
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl text-xs font-semibold bg-[#000048] hover:bg-[#480878] text-white transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
      ...
      <section className="py-16 text-center max-w-4xl mx-auto px-4">
        <div className="p-10 rounded-3xl bg-gradient-to-br from-[#000048] via-[#480878] to-[#7000F8] border border-[#9030F8]/30 space-y-5 shadow-xl">
          <h3 className="text-2xl sm:text-3xl font-bold text-white">
            Have a Digital, Software, or AI Challenge?
          </h3>
          ...
          <button
            onClick={onOpenProjectModal}
            className="px-8 py-3.5 rounded-xl text-xs sm:text-sm font-semibold bg-white hover:bg-[#F7F7FC] text-[#000048] shadow-lg transition-all cursor-pointer"
          >
